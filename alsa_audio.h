...
#endif
#ifndef ANDROID_USB_AUDIO_INTERFACE_H
#define ANDROID_USB_AUDIO_INTERFACE_H
...
#define USB_AUDIO_HARDWARE_MODULE_ID "audio.usb"

// Конфигурация аудио (совпадает с вашим кодом)
#define USB_AUDIO_SAMPLE_RATE 8000
#define USB_AUDIO_CHANNEL_COUNT 1
#define USB_AUDIO_FORMAT AUDIO_FORMAT_PCM_16_BIT
#define USB_AUDIO_FRAME_SIZE 2 // 16-bit mono = 2 bytes per frame
...
struct usb_audio_device {
    ...
    int usb_fd; // файловый дескриптор для /dev/ttyUSB4
